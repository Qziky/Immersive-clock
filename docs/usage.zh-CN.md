...
在“设置 → 视觉外观”中可分别编辑时钟、倒计时、秒表和自习页面。组件样式支持对子元素
设置颜色、透明度、字体、字重、字间距、阴影、表面、边框和圆角；修改会实时预览，只有
点击“保存”才会写入本地配置，取消会恢复已保存外观。页面背景可分别设置为预设、纯色或
本地图片。每个属性均可继承上级设置，并支持重置子元素、组件、页面或全部外观。
