...
- 设置分组导航、天气/定位内容隔离、定位设置与状态同页展示、系统自适应更新状态、手动城市搜索选择与无选择禁止保存、七标签实时详情，以及 1440×900/390×844/320×568 无溢出和控制台检查：[settings-persistence.e2e.spec.ts](file:///d:/Desktop/Immersive-clock/tests/e2e/settings-persistence.e2e.spec.ts)
